...
map.getView().fit([-507669.043956, 5958906.531987, 9626.667533, 6233405.038622], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Exo web mapping sur le Departement de Bretagne et ses zones habitations</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (54 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette carte est une carte d\'exercice sur le wepmapping';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Surfacedecommuneenha_3,
    colName: 'POPULATION',
    zoom: 10,
    collapsed: true,
    map: map
